...
Public Class loginOld
    ...
    ''' <summary>
    ''' AUTOR: FECLIX ONTANEDA
    ''' COMENTARIO: EVENTO PARA DESCOMPONER QUERYSTRING Y GRABAR EN TABLA DE LOG
    ''' </summary>
    ''' <remarks></remarks>
    ...
    Private Sub LoginUsuario()
        Try
            ...
            dtLoginUsuario = LoginAdapter.LoginUsuario(Me.txtUsuario.Text.Trim(), Me.txtPassword.Text.Trim())
            ...
            Else
                ...
                If msg = "UNE" Then
                    ...
                    Me.lblMsg001.Text = "El usuario no existe en el sistema"
                    Me.txtPassword.Text = ""
                    Me.txtUsuario.Focus()
                End If
                ...
                If msg = "UNA" Then
                    Me.lblMsg001.Visible = True
                    Me.lblMsg001.Text = "El usuario no se encuentra en estado ACTIVO"
                    Me.txtPassword.Text = ""
                    Me.txtUsuario.Focus()
                End If
                ...
                If msg = "PIN" Then
                    Me.lblMsg001.Visible = True
                    Me.lblMsg001.Text = "La contraseña es incorrecta"
                    Me.txtPassword.Text = ""
                ...
                If msg = "NES" Then
                    Me.lblMsg001.Visible = True
                    Me.lblMsg001.Text = "Usted no puede realizar un inicio de sesión por el momento."
                    Me.txtPassword.Text = ""
                    Me.txtPassword.Focus()
                End If
                ...
                If msg = "PCD" Then
                    Me.lblMsg001.Visible = True
                    Me.lblMsg001.Text = "Su contraseña ha caducado"
                    Me.txtPassword.Text = ""
                    Me.txtUsuario.Focus()
                End If
                ...
                If msg = "ACT" Then
                    InfoUsuario()
                    Session("user") = Me.txtUsuario.Text.Trim()
