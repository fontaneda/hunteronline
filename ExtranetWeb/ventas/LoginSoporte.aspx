<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LoginSoporte.aspx.vb" Inherits="ExtranetWeb.LoginSoporte" %>
        ...
        <header>
            ...
            <section class="wrap">
                ...
                <div class="login-section">
                    ...
                    <form class="sign-form" runat="server" action="" >
                        <p>Ingrese sus datos</p>
                        <asp:TextBox ID="txt_Usuario" runat="server" class="input-field"
                                type="text" MaxLength="6" TabIndex="1" placeholder="Usuario">
                        </asp:TextBox>
                        ...
                        <asp:Button ID="Btn_Login" runat="server" Text="Ingresar" CssClass="form-submit-btn"
                            TabIndex="3" onclick="BtnLogin_Click" ><%--Enabled="false"--%>
                        </asp:Button>
                    </form>
