Public Class busquedataller
    ...
    Private Sub BtnConsulta_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnConsulta.Click
        Try
            Dim dTDatosTaller As New DataSet
            dTDatosTaller = VehiculoTurnoAdapter.ConsultaControles(5, 0)
            rgdconsulta.DataSource = dTDatosTaller
