<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="busquedatelefono.aspx.vb" Inherits="ExtranetWeb.busquedatelefono" EnableSessionState="True" %>
                ...
                <script type="text/javascript">
                    ...
                    function returnToParent() 
                    {
                        ...
                        for (var i = 0; i < selectedRows.length; i++) 
                        {
                            ...
                            var fijo = MasterTable.getCellByColumnUniqueName(row, "TELEFONO")
                        ...
                        if (oArg.telefono) 
                        {
                            ...
                            alert("Por favor seleccione un teléfono.");
                        }
                    }
                </script>
                <div class="busqueda">
                    ...
                    <div class="data">
                        <telerik:RadGrid ID="rgdconsulta" runat="server" CellSpacing="0" Culture="es-ES"
                            ...
                            <MasterTableView>
                                ...
                                <Columns>
                                    <telerik:GridBoundColumn DataField="TIPO_TELEFONO" HeaderText="Tipo Teléfono" UniqueName="TIPO_TELEFONO">
