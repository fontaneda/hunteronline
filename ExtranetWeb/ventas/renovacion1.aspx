<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ventas/master.Master"
    CodeBehind="renovacion1.aspx.vb" Inherits="ExtranetWeb.renovacion1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content_principal">
        ...
        <%-- <telerik:RadButton ID="btnregresaproductos" runat="server" Text="Nuevo" ForeColor="Black"
                    Style="top: 0px; left: 0px; height: 32px; width: 32px" ToolTip="Regresar a la selección de transacciones">
    ...
    <div class="content_crit_info_detalleitems_productocliente">
        <telerik:RadTabStrip ID="RadTabPrincipal" runat="server" AutoPostBack="True" Width="880px"
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" Height="390px"
            ...
            <telerik:RadPageView runat="server" ID="RadPageView1" CssClass="corporatePageView">
                <div class="content_renovacion_confirmardato_bloque">
                    <div class="content_renovacion_confirmardato_bloque_col1">
                        ...
                        <div class="content_renovacion_confirmardato_gridcontrol">
                            <telerik:RadGrid ID="productocliente" runat="server" CellSpacing="0" Culture="es-ES"
                                Width="580px" Height="410px" GridLines="None" AutoGenerateColumns="False" AllowAutomaticUpdates="True"
                                Skin="Windows7">
                                <ClientSettings>
                                ...
                                <MasterTableView DataKeyNames="CODIGO_VEHICULO">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn AllowFiltering="False" FilterControlAltText="Filter ANIO column"
                                            ...
                                            <ItemTemplate>
                                                <telerik:RadComboBox runat="server" ID="cbxconsc01" Width="50px" Filter="Contains"
                                                    OnSelectedIndexChanged="cbxconsc01_SelectedIndexChanged" AutoPostBack="True">
                                                </telerik:RadComboBox>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                    ...
                    <div class="content_renovacion_confirmardato_bloque_col2">
                        <div class="content_renovacion_confirmardato_totales">
                            <div class="content_renovacion_confirmardato_master01">
                                ...
                                <div class="content_renovacion_confirmardato_totales_label2">
                                    Total a Pagar
                                </div>
                                <div class="content_renovacion_confirmardato_totales_textbox2">
                                    <asp:Label ID="lbltotal" runat="server"></asp:Label>
                                </div>
                                <div class="content_renovacion_confirmardato_totales_labeldivision">
                                </div>
                                <div class="content_renovacion_confirmardato_totales_label_boton">
                                    <telerik:RadButton ID="btnConfirmarDatoContinuar" runat="server" Text="CONTINUAR">
                                    </telerik:RadButton>
                                </div>
                                <div class="content_renovacion_confirmardato_totales_label_formapago">
                                    Ir a formas de pago
                                </div>
                            </div>
                        </div>
