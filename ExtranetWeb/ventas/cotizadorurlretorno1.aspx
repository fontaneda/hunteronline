<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ventas/master.Master"
    CodeBehind="cotizadorurlretorno1.aspx.vb" Inherits="ExtranetWeb.cotizadorurlretorno1" %>
            ...
            <div class="content_crit_info_detalleitems_productocliente">
                <div class="content_datospersonales_bloque">
                    <div class="content_cotizadorurlretorno_bloque">
                        ...
                        <asp:Label ID="lbltaxvalue2" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lblreferencia1" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lblreferencia2" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lblreferencia3" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lblreferencia4" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lblreferencia5" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lblestadoautorizacion" runat="server" Text=""></asp:Label>
                    </div>
                </div>
            </div>
        </div>
