<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ventas/master.Master" CodeBehind="vehiculo.aspx.vb" Inherits="ExtranetWeb.vehiculo" %>
        ...
        <section class="info-body">                    
            ...
            <div class="bienes-selection">
                <ul>
                    ...
                    <li>
                        <a class="btn-class btn-disable" href="vehiculobien.aspx">
                            Otros Bienes
                        </a>
                    </li>
                </ul>
                ...
                <div class="bienes-items activo">
                    <div class="bienes-item-info">
                        ...
                        <p class="item-desc">
                            ...
                            <asp:Label ID="lblcodigo" text='<%# Eval("IdVehiculo") %>' runat="server" Visible="false"/>
                        </p>
                        <ul>
                            <li>
                                <h4>Chasis:</h4>
