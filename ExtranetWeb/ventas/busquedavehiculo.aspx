<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="busquedavehiculo.aspx.vb" Inherits="ExtranetWeb.busquedavehiculo" %>
                ...
                <script type="text/javascript">
                    ...
                    function returnToParent() {
                        ...
                        for (var i = 0; i < selectedRows.length; i++) {
                            ...
                            var codigo = MasterTable.getCellByColumnUniqueName(row, "IdVehiculo")
                            oArg.codigo = codigo.innerHTML;
                            var nombre = MasterTable.getCellByColumnUniqueName(row, "VehiculoNombre")
                ...
                <div class="table-data">
                    <div class="top-tabla-options">
                        <div class="search-client">
                            <input type="text" placeholder="placa/motor/chasis/cliente/vehiculo netsuite" id="txtbusquedaclientefac" runat="server"> 
                        </div>
                        <div class="icono">
                        ...
                        <telerik:RadGrid ID="rgdconsulta" runat="server" CellSpacing="0" Culture="es-ES" GridLines="None" AutoGenerateColumns="False"
                            ...
                            <MasterTableView>
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="NombreCliente" HeaderText="Cliente" UniqueName="NombreCliente">
                                    ...
                                    <telerik:GridBoundColumn DataField="Chasis" HeaderText="Chasis" UniqueName="Chasis">
                                        <FooterStyle Width="140px" CssClass="estilogridcontrol" />
                                        <HeaderStyle Font-Bold="True" Width="140px" CssClass="estilogridcontrol" />
                                        <ItemStyle Width="140px" CssClass="estilogridcontrol" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="Motor" HeaderText="Motor" UniqueName="Motor">
                                        <FooterStyle Width="140px" CssClass="estilogridcontrol" />
                                        <HeaderStyle Font-Bold="True" Width="140px" CssClass="estilogridcontrol" />
                                        <ItemStyle Width="140px" CssClass="estilogridcontrol" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="ColorCarseg" HeaderText="Color" UniqueName="ColorCarseg">
                                        <FooterStyle Width="100px" CssClass="estilogridcontrol" />
                                        <HeaderStyle Font-Bold="True" Width="100px" CssClass="estilogridcontrol" />
                                        <ItemStyle Width="100px" CssClass="estilogridcontrol" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="IdVehiculo" HeaderText="Cod_Vehiculo" UniqueName="IdVehiculo">
                                        <FooterStyle Width="100px" CssClass="estilogridcontrol" />
                                        <HeaderStyle Font-Bold="True" Width="100px" CssClass="estilogridcontrol" />
                                        <ItemStyle Width="100px" CssClass="estilogridcontrol" />
                                    </telerik:GridBoundColumn>
                                     <telerik:GridBoundColumn DataField="VehiculoNombre" HeaderText="Desc_Vehiculo" UniqueName="VehiculoNombre">
                                        <FooterStyle Width="300px" CssClass="estilogridcontrol" />
                                        <HeaderStyle Font-Bold="True" Width="300px" CssClass="estilogridcontrol" />
                                        <ItemStyle Width="300px" CssClass="estilogridcontrol" />
                                    </telerik:GridBoundColumn>
                                </Columns>
                                <EditFormSettings>
