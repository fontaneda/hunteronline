<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ventas/master.Master" CodeBehind="renovacion.aspx.vb" Inherits="ExtranetWeb.renovacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="Form1" action="#" runat="server">
        <section class="info-body"> 
           ...
           <%-- <div style="width:auto; height:30px; margin:10px auto; visibility:visible;" >
                <asp:CheckBox id="chkdebito" runat="server" style="margin-top:7px;" Checked="false"></asp:CheckBox>
                <asp:Label ID="lbldebito" runat="server" Text="Seleccione si desea aplicar a DÉBITO RECURRENTE" Font-Bold="true" Font-Size="Medium" ForeColor="Brown"/>
            </div>--%>
            ...
            <ItemTemplate>              
                <div class="table-data" id="tbl00" runat="server">
                    ...
                    <asp:Label ID="lblgrupoitem1" text='<%# Eval("IDEJECUTIVO") %>' runat="server" Visible="false" ForeColor="Transparent"/>
                    <table>
                        <thead>
                            <tr>
                                <th>Servicios</th>
