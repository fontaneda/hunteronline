<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ventas/master.Master" CodeBehind="RenovacionFact.aspx.vb" Inherits="ExtranetWeb.RenovacionFact" %>
            ...
            <section class="info-body">                    
                ...
                <div class="info-pago">
                    ...
                    <div class="tarjetas">
                        ...
                        <ul>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisorvisa" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/visa.png" alt="">
                            </li>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisormastercard" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/master.png" alt="">
                            </li>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisordiners" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/diners.png" alt="">
                            </li>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisordiscover" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/discover.png" alt="">
                            </li>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisoramerican" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/american.png" alt="">
                            </li>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisortitanium" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/visatitanium.png" alt="">
                            </li>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisorpacificard" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/pacificard.png" alt="">
                            </li>
                            <li>
                                <asp:RadioButton name="tarjeta" id="chkemisorpichincha" runat="server" AutoPostBack="true" GroupName="grptarjeta"/>
                                <img src="../images/img_mkt/pichincha.png" alt="">
                            </li>
                        </ul>
                    </div>
                    <div class="bco-tarjeta-select">
                        <asp:DropDownList class="select-css" id="cmbbancos" runat="server">
                        </asp:DropDownList>
                    </div>
                    <div class="bco-tarjeta-select"> 
                        <asp:DropDownList class="select-css" id="cmbtipopago" runat="server">
                        </asp:DropDownList>
                    </div>
                </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lbltipodireccionfac" text='<%# Eval("TipoDireccion")%>' runat="server" Visible="false"/>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblciudadfac" text='<%# Eval("Canton")%>' runat="server"/>
                                        </td>
                                        <td>
                                            <asp:Label ID="lbldireccionfac" text='<%# Eval("Direccion1")%>' runat="server"/>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblinterseccionfac" text='<%# Eval("Parroquia")%>' runat="server"/>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblnumerofac" text="" runat="server" Visible="false"/>
                                        </td>
                                        <td>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lbltipotelefonofac" text='<%# Eval("TIPOTELEFONO")%>' runat="server"/>
                                        </td>
                                        <td>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lbltipocelularfac" text='<%# Eval("IdTipoTelefono")%>' runat="server"/>
                                        </td>
                                        <td>
