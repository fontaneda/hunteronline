<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ventas/master.Master" 
    CodeBehind="cotizadorurlretornoalignet.aspx.vb" Inherits="ExtranetWeb.cotizadorurlretornoalignet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadWindow ID="modalPromocion" runat="server" Width="788px" Height="600px"
            Modal="true" Behaviors="Close" CssClass="elementpromocion" Title=""
            Skin="MyCustomSkin" VisibleStatusbar="False" EnableEmbeddedSkins="False"  >
            <ContentTemplate>
               <div id="Div1" class="masterradwindowspromocionimagen_renovacion" runat="server" >
                  <br />
                   <br />
                   <br />
                   <br />
                   ...
                   <br />
                   <br />
                   <font class="letra_promocion_titulo_renovacion"><asp:Label ID="lblcodigo" runat="server" Text="Label"></asp:Label></font>
                   <br />
                   <br />
                   <br />
                   <br />
                   <font class="letra_promocion_titulo_renovacion"><asp:Label ID="lblcodigo2" runat="server" Text="Label"></asp:Label></font>
                </div>
            </ContentTemplate>
        </telerik:RadWindow>
        <telerik:RadWindow ID="modalPromocion1" runat="server" Width="788px" Height="600px"
            Modal="true" Behaviors="Close" CssClass="elementpromocion" Title=""
            Skin="MyCustomSkin" VisibleStatusbar="False" EnableEmbeddedSkins="False"  >
            <ContentTemplate>
               <div id="Div2" class="masterradwindowspromocionimagen_renovacion_act" runat="server" >
                  <br />
                   <br />
                   <br />
                   <br />
                   ...
                   <br />
                   <br />
                   <font class="letra_promocion_titulo_renovacion"><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></font>
                   <br />
                   <br />
                   <br />
                   <br />
                   <font class="letra_promocion_titulo_renovacion"><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></font>
                   <br />
                   <br />
                   <br />
                   <br />
                   <font class="letra_promocion_titulo_renovacion"><asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></font>
                </div>
            </ContentTemplate>
        </telerik:RadWindow>
</asp:Content>