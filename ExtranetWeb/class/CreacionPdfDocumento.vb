...
Public Class CreacionPdfDocumento
    ...
    Public Overrides Sub OnEndPage(writer As PdfWriter, doc As Document)
        Try
            ...
            'Dim logo As iTextSharp.text.Image = iTextSharp.text.Image.GetInstance(HttpContext.Current.Server.MapPath("/images/logo/logo_hunter.png"))
            Dim logo As iTextSharp.text.Image = iTextSharp.text.Image.GetInstance("https://www.hunteronline.com.ec/IMGCOTIZADORWEB/Imagenescampanias/Logo_hunter.png")

            'logo.ScaleAbsolute(540.0F, 65.0F)
            logo.ScalePercent(86.0F)
            ...
            cb2.ShowTextAligned(Element.ALIGN_CENTER, "", doc.PageSize.Width - 10, doc.PageSize.Height / 2, -90)
            cb2.EndText()
