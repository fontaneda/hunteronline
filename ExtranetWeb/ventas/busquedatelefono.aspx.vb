Public Class busquedatelefono
    ...
    Private Sub BtnConsulta_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnConsulta.Click
        Try
            ...
            dTDatosDireccion = DatosPersonalesAdapter.ConsultaDatosTelefonoCliente(Session.Item("user"), "001")
            rgdconsulta.DataSource = dTDatosDireccion
