<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Vehiculorolbien.aspx.vb" Inherits="ExtranetWeb.Vehiculorolbien" %>
            ...
            <form id="Form1" action="#" runat="server">
                <section class="info-body">  
                    ...
                    <div class="bienes-selection">
                        <ul>
                            <li>
                                <a class="btn-class btn-disable" href="vehiculorol.aspx">
                                    Vehiculos
                                </a>
                            </li>
                            <li>
                            ...
                            <div class="bienes-item-info">
                                <div class="bien-item-title">
                                    ...
                                    <p>
                                        ...
                                        <asp:Label ID="lblcodigoveh" text='<%# Eval("CODIGO") %>' runat="server" Visible="false"/>
                                    </p>
                                </div>
                                <p class="item-desc">
                                    <b>
