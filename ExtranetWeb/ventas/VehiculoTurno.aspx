<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/ventas/master.Master"  CodeBehind="VehiculoTurno.aspx.vb" Inherits="ExtranetWeb.VehiculoTurno" %>
     ...
     <form id="Form1" action="#" runat="server">
         <section class="info-body">
            ...
            <div class="select-group" >
                <asp:DropDownList ID="cmbproductortur" runat="server" AutoPostBack="true" class="select-css" placeholder="Seleccione" />
